    ...
    >
      <div className="w-full max-w-md animate-in zoom-in-95 duration-200">
        ...
        <div className="relative border border-[#1b1d20] bg-[#0f1012] shadow-2xl">
          ...
          <button
            onClick={() => router.back()}
            className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center text-[#6f6f6f] hover:text-[#d6d7da] hover:bg-[rgba(255,255,255,0.05)] transition-all text-[20px] leading-none"
            aria-label="Close"
          >
            ×
          </button>
